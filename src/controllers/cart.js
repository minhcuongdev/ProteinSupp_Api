...
export const updateQualityProduct = async (req, res) => {
  try {
...
export const createCart = async (req, res) => { 
  try {
    ...
    if(!product) return req.status(404).json("Not found product")
...
export const deleteCart = async (req, res) => {
  try {
    ...
    if(!removeCart) return res.status(404).json("Not found product that you want to delete")
